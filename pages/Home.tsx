        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
           <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="animate-slide-in-left">
                <h2 className="text-3xl font-bold text-gray-900 mb-6">Why Choose Aaroon Enterprises?</h2>
              ...
              <div className="relative animate-slide-in-right">
                 ...
                 <img src={whyChooseImage} className="rounded-3xl shadow-2xl w-full relative z-10 border-4 border-white/30" alt="Happy Technician" />
